    ...
    data: {
        ...
        stats: {
            data: {
                ...
                btts: number;
                goal_line: { over: {}, under: { } },
                avg_corners_per_match: number;
                team_most_corners_count: number;
                team_most_corners_id: number;
                goals_conceded: { all: number; home: number; away: number},
                goals_scored: { all: number; home: number; away: number},
                win_percentage: { all: number; home: number; away: number },
                defeat_percentage: { all: number; home: number;away: number},
